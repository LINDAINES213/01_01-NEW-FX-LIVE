---
title: "FX Live - Análisis Técnico y de Riesgo - Costa Rica"
output:
  html_document:
    toc: true
    toc_depth: 3
...
p_bottom <- ggplot(data_24m, aes(x = Fecha)) +
  ...
  geom_ribbon(aes(ymin = Lower20, ymax = Higher20), alpha = 0.15, fill = "#e776ebff") +
  geom_ribbon(aes(ymin = Lower50, ymax = Higher50), alpha = 0.10, fill = "#7c1e64ff") +
  geom_line(aes(y = SMA50), color = "#7c1e64ff", linewidth = 0.9) +
  geom_line(aes(y = SMA20), color = "#e776ebff", linewidth = 0.9) +
  labs(
