---
title: "FX Live - Análisis Técnico y de Riesgo - República Dominicana"
output:
  html_document:
    toc: true
    toc_depth: 3
...
p_bottom <- ggplot(data_24m, aes(x = Fecha)) +
  ...
  geom_ribbon(aes(ymin = Lower20, ymax = Higher20), alpha = 0.15, fill = "#a4ff81ff") +
  geom_ribbon(aes(ymin = Lower50, ymax = Higher50), alpha = 0.10, fill = "#269123ff") +
  geom_line(aes(y = SMA50), color = "#269123ff", linewidth = 0.9) +
  geom_line(aes(y = SMA20), color = "#a4ff81ff", linewidth = 0.9) +
  labs(
