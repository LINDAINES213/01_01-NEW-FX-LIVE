---
title: "FX Live - Análisis Técnico y de Riesgo - México"
output:
  html_document:
    toc: true
    toc_depth: 3
...
p_bottom <- ggplot(data_24m, aes(x = Fecha)) +
  ...
  geom_ribbon(aes(ymin = Lower20, ymax = Higher20), alpha = 0.15, fill = "#0cbb29ff") +
  geom_ribbon(aes(ymin = Lower50, ymax = Higher50), alpha = 0.10, fill = "#024d0fff") +
  geom_line(aes(y = SMA50), color = "#024d0fff", linewidth = 0.9) +
  geom_line(aes(y = SMA20), color = "#0cbb29ff", linewidth = 0.9) +
  labs(
