---
title: "FX Live - Análisis Técnico y de Riesgo - Honduras"
output:
  html_document:
    toc: true
    toc_depth: 3
...
current_formatted <- tibble(
  ...
  Valor = c(
    ...
    paste0("L ", round((current_data$volatility_20 / 100 * current_data$D_Close), 3)),
...
p_bottom <- ggplot(data_24m, aes(x = Fecha)) +
  ...
  geom_ribbon(aes(ymin = Lower50, ymax = Higher50), alpha = 0.10, fill = "#104263ff") +
  geom_line(aes(y = SMA50), color = "#104263ff", linewidth = 0.9) +
